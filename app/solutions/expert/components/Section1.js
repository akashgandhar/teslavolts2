...
export default function Section1() {
  return (
    <motion.div
      ...
      class="flex flex-1 w-full flex-col items-center justify-center text-center px-4 py-28 bg-gradient-to-r from-green-50/50 via-teal-50 to-green-50/50 "
    >
      <motion.a
      ...
      >
        Advice from our EV professionals
      ...
      >
        Embrace the EV revolution with a unique business plan.
Want to enter the EV market but are unsure of where to begin?
