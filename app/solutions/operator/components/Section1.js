...
export default function Section1() {
  return (
    ...
    >
      ...
      >
        EV charging solutions for charge point operators. Set-up up a successful
        EV business model with our smart EV solutions. We offer different
        packages fitting to your needs.
      </motion.h2>
      <a
