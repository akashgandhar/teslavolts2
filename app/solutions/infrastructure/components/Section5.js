          ...
          <div class="w-full md:w-1/2 md:px-3 text-right ">
            ...
            >
              <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                <span class="block xl:inline ">Fleet Charging{" "}</span>
                {/* <br />
              ...
              With governmental regulations in India increasingly restricting
                the use of internal combustion engine vehicles in urban zones,
                future-proofing your company is essential through fleet
                electrification. Transitioning to an electric fleet not only
                promotes sustainability but also significantly cuts down
                operational costs via reduced fuel and maintenance expenses. Our
                platform solution simplifies the process for fleet operators to
                migrate to entirely electric vehicles, thereby facilitating this
                crucial transition.
              </p>
