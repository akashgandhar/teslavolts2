...
export default function Section1() {
  return (
    <motion.div
      ...
      class="flex flex-1 w-full bg-[url('/solutions/op3.png')] min-h-screen bg-cover flex-col items-center justify-center text-center px-4 py-28 "
    >
      <motion.a
        ...
        animate="show"
        href=""
        class="border border-white-700  rounded-lg py-2 px-4 text-[#ddd]  text-sm mb-5 transition duration-300 ease-in-out hover:text-gray-500 dark:hover:text-gray-400"
      >
        Speed Up & Save Hours
      </motion.a>
      <motion.h1
        ...
        initial="hidden"
        animate="show"
        class="mx-auto max-w-4xl font-display text-5xl font-bold tracking-normal text-white  sm:text-7xl"
      >
        Oil & Gas companies
        ...
        <span class="relative whitespace-nowrap text-blue-500 ">
          ...
          <span class="relative">with TeslaVolts</span>
        </span>
      </motion.h1>
      <motion.h2
        variants={fadeIn("down", "spring", 0, 1)}
        initial="hidden"
        animate="show"
        class="mx-auto mt-12 max-w-xl text-lg sm:text-white-400 text-[#ddd]  leading-7"
      >
        ...
        Discover our intelligent EV charging solutions.
      </motion.h2>
      <a
