          ...
          <div class="w-full md:w-1/2 md:px-3 text-right ">
            ...
            >
              <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                <span class="block xl:inline ">Oil and gas firms use our solution</span>
                {/* <br />
              ...
              Create your own EV charging infrastructure with our charge point
                software. The software is user-friendly and includes all the
                capabilities you’ll need to grow your EV business, including
                roaming, billing, and smart charging. We provide packages for
                our EV charging station software that are both managed and
                entirely outsourced.
              </p>
